warn("FISHNPC SCRIPT STARTING - LINE 1")
...
-- Animation IDs
local ANIM_WALK = 123526509932273
local ANIM_IDLE = 134249275396029
local ANIM_ATTACK = 87781147243832

local NPCS = {}

-- FishSpawn model (search recursively in case it's in a folder)
local spawnModel = Workspace:FindFirstChild("FishSpawn", true)
if not spawnModel then 
	warn("[FishNpc] ❌ FishSpawn model not found in Workspace!")
	return
end
print("[FishNpc] ✅ Found FishSpawn model at: " .. spawnModel:GetFullName())
