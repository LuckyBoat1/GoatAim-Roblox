...
-- TorsoGhostSpawn model (recursive search — may be inside Game.Abyss.AbyssModels)
local spawnModel = Workspace:FindFirstChild("TorsoGhostSpawn", true)
if not spawnModel then error("TorsoGhostSpawn model missing") end
