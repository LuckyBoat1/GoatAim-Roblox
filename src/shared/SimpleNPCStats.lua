...
SimpleNPCStats.Spidy = withDefaults({
	...
	EXP = 10,
	DROPS = {
		{ item = "Gold", chance = 1, amount = {10, 25} },
...
SimpleNPCStats.TorsoGhost = withDefaults({
	...
	EXP = 8,
	DROPS = {
		{ item = "Gold", chance = 1, amount = {8, 20} },
...
SimpleNPCStats.Skelly = withDefaults({
	...
	EXP = 15,
	DROPS = {
		{ item = "Gold", chance = 1, amount = {15, 30} },
...
SimpleNPCStats.Robo = withDefaults({
	...
	EXP = 20,
	DROPS = {
		{ item = "Gold", chance = 1, amount = {20, 40} },
...
SimpleNPCStats.RedPiggy = withDefaults({
	...
	EXP = 10,
	DROPS = {
		{ item = "Gold", chance = 1, amount = {10, 22} },
		{ item = "Bronze", chance = 0.08, amount = {1, 1} },
		{ item = "Silver", chance = 0.03, amount = {1, 1} },
		{ item = "Sapphire", chance = 0.01, amount = {1, 1} },
		{ item = "Omega", chance = 0.005, amount = {1, 1} },
...
SimpleNPCStats.MamaGhost = withDefaults({
	...
	EXP = 25,
	DROPS = {
		{ item = "Gold", chance = 1, amount = {25, 40} },
...
SimpleNPCStats.BabyGhost = withDefaults({
	...
	EXP = 5,
	DROPS = {
		{ item = "Gold", chance = 1, amount = {5, 15} },
...
SimpleNPCStats.End = withDefaults({
	...
	EXP = 300,
	DROPS = {
		{ item = "Gold",     chance = 1,    amount = {1000, 2000} },
		{ item = "Bronze",   chance = 0.65, amount = {1, 3} },
		{ item = "Silver",   chance = 0.55, amount = {1, 3} },
		{ item = "Sapphire", chance = 0.45, amount = {1, 2} },
		{ item = "Omega",    chance = 0.16, amount = {1, 2} },
...
SimpleNPCStats.WorldBreaker = withDefaults({
	...
	EXP = 500,
	DROPS = {
		{ item = "Gold",     chance = 1,    amount = {2500, 5000} },
		{ item = "Bronze",   chance = 0.75, amount = {1, 4} },
		{ item = "Silver",   chance = 0.65, amount = {1, 3} },
		{ item = "Sapphire", chance = 0.60, amount = {1, 3} },
		{ item = "Omega",    chance = 0.20, amount = {1, 2} },
...
SimpleNPCStats.TheWeepingKing = withDefaults({
	...
	EXP = 1000,
	DROPS = {
		{ item = "Gold",     chance = 1,    amount = {8000, 12000} },
		{ item = "Bronze",   chance = 0.90, amount = {1, 5} },
		{ item = "Silver",   chance = 0.80, amount = {1, 4} },
		{ item = "Sapphire", chance = 0.75, amount = {1, 4} },
		{ item = "Omega",    chance = 0.24, amount = {1, 3} },
...
SimpleNPCStats.TwoFace = withDefaults({
	...
	EXP = 350,
	DROPS = {
		{ item = "Gold",     chance = 1,    amount = {1500, 2500} },
		{ item = "Bronze",   chance = 0.70, amount = {1, 3} },
		{ item = "Silver",   chance = 0.60, amount = {1, 3} },
		{ item = "Sapphire", chance = 0.54, amount = {1, 2} },
		{ item = "Omega",    chance = 0.18, amount = {1, 2} },
...
SimpleNPCStats.Dice = withDefaults({
	...
	EXP = 200,
	DROPS = {
		{ item = "Gold",     chance = 1,    amount = {500, 1000} },
		{ item = "Bronze",   chance = 0.60, amount = {1, 3} },
		{ item = "Silver",   chance = 0.50, amount = {1, 2} },
		{ item = "Sapphire", chance = 0.36, amount = {1, 2} },
		{ item = "Omega",    chance = 0.12, amount = {1, 2} },
