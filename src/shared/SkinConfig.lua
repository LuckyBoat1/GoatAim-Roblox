...
local WEAPON_BASE_DAMAGE = {
	-- Guns (balanced: 8-10 range, max 3 difference)
	Pistol   = 8,
	Revolver = 9,
	SMG      = 8,
	Rifle    = 9,
	...
	-- Melee (balanced: 9-12 range, max 3 difference)
	Blade      = 10,
	Sword      = 11,
	Axe        = 12,
	GreatAxe   = 12,
...
-- Tuned so mythic weapons reach up to 200 (capped there); legendary ~2.5x common.
...
--	["Gold Revolver"] = { weapon="Revolver", rarity="epic", adsAllowed=true },       -- OLD: ["Gold Revolver"]
	["Basic Camo"] = { weapon="Rifle", rarity="rare", adsAllowed=false },       -- OLD: ["Grand Prix"]
...
function SkinConfig.GetDamage(skinId)
	...
	return math.min(math.floor(baseDamage * rarityMultiplier), 200)
end
